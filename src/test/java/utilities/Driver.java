...
public class Driver {
    ...
    public static WebDriver getDriver() {
        ...
        // we added if statement because, when we ran test methods it may try to open another driver by
        // using this method
    ...
    // to close opened driver // if a driver is opened, this method will close it. If there is no
    // drider, it wont do anything
